...
def lambda_handler(event, ctx):
    ...
    logger.info(f'recebido evento para evnio de mensagem com o payload {event}')
    ...
    for record in records:
        ...
        for chatId in recipients:
            ...
            logger.info(f'Enviando mensagem usando bot: {botName} para chat: {chatId}, método: {methodName}, complemento: {textMessage}')
            ...
            logger.info(f'Parâmetros do request. Url {botUrl}, Options: {options}')
